...
_message = _message + " <a href='www.steel-gamers.fr' color='#56BDD6'>Altis Life</a> -- Venez visitez notre forum.<br /><br />";
_message = _message + "Teamspeak 3 Address: ts.steel-gamers.fr  <br /><br />";
