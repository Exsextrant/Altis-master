...
*/
	...
	player createDiaryRecord["safezones",
		[
			"Les Safe Zones",
				"
					Les Safe zones sont des lieux dans les quelles il est totalement interdis de tue ou voler des personnes.<br/><br/>

					Les deux villes principal delimiter par des marqueur rond vert<br/>
					Les commissaria<br/>
					Les camps rebelle et criminel<br/>
					Lieux Donateur<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Bannable Offenses",
				...
				1. Hacking<br/>
				2. Cheating<br/>
				3. Exploitation de Bug<br/>
				4. Après trois kick vous serez automatiquement bannis du serveur ainsi que du réseau informatique en notre possesion.<br/><br/>
				"
		]
	];
